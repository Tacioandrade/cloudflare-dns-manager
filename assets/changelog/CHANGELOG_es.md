...
## [2.0.10] - 2026-09-16
### Corregido
- Se permitieron los guiones bajos y los demás caracteres válidos en nombres DNS para los destinos de registros CNAME, MX, NS y SRV, manteniendo los límites de tamaño definidos para nombres y etiquetas DNS.
...
- Se añadieron pies de lista adaptables con la misma altura y los mismos márgenes que los botones de acción flotantes, evitando que cubran el último elemento en pantallas de ordenador, tableta o móvil.
- Se actualizó el builder de Linux a Flutter 3.38.10, alineándolo con `pubspec.lock` y el pipeline de lanzamiento.
- Se añadieron textos de ayuda al pasar el cursor sobre las acciones de proxy, edición y eliminación de registros DNS.
...
## [2.0.4] - 2026-07-27
### Añadido / Modificado
- Añadida en macOS la comprobación diaria de nuevas versiones al abrir la aplicación, manteniendo esta función desactivada en iOS.
- Corregido el nombre mostrado de la aplicación en Android y en los metadatos Web a Cloudflare DNS Manager.
- Añadida una opción Docker para generar el Android App Bundle (AAB) destinado a su publicación en Google Play Store.
- Actualizada la cadena de compilación de Android a Flutter 3.38.10, Android Gradle Plugin 8.11.1 y Gradle 8.14.
- Actualizados los niveles de API de Android al mínimo 24 y objetivo 36, según los requisitos de Google Play Store.
...
- Ajustados los permisos de red y Keychain, los metadatos públicos y las referencias del producto en Xcode.

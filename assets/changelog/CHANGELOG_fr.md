...
- Ajout d’un tutoriel de configuration du jeton API Cloudflare sur l’écran d’accueil lorsqu’aucun jeton n’est configuré, avec un lien de création et les autorisations requises.

## [2.0.8] - 2026-08-28
### Ajouté / Modifié
- Ajout des totaux de domaines et d’enregistrements DNS dans les pieds de leurs listes respectives, y compris le nombre d’enregistrements A, CNAME et TXT.
- Ajout de pieds de liste adaptatifs ayant la même hauteur et les mêmes marges que les boutons d’action flottants, afin qu’ils ne masquent pas le dernier élément sur ordinateur, tablette ou mobile.
- Mise à jour du builder Linux vers Flutter 3.38.10, en l’alignant sur `pubspec.lock` et le pipeline de publication.
- Ajout de textes d’aide au survol pour les actions de proxy, de modification et de suppression des enregistrements DNS.

## [2.0.6] - 2026-08-11
### Ajouté / Modifié
- Ajout d’une option permettant de copier un enregistrement DNS depuis la liste, avec un formulaire prérempli et une validation empêchant les doublons.
- Standardisation du pipeline de publication sur Flutter 3.38.10 pour les builds Linux, Windows et macOS.
...
- Correction du nom affiché de l’application sous Android et dans les métadonnées Web en Cloudflare DNS Manager.
- Ajout d’une option Docker pour générer l’Android App Bundle (AAB) destiné à la publication sur le Google Play Store.
- Mise à jour de la chaîne de compilation Android vers Flutter 3.38.10, Android Gradle Plugin 8.11.1 et Gradle 8.14.
- Mise à jour des niveaux d’API Android avec un minimum de 24 et une cible de 36, conformément aux exigences du Google Play Store.

## [2.0.3] - 2026-07-24
### Ajouté / Modifié
- Ajout du support natif et de la documentation de compilation pour iOS et macOS.
- Ajout de la compilation automatique du bundle macOS dans GitHub Actions pour les commits de version.
- Ajustement des autorisations réseau et Keychain, des métadonnées publiques et des références du produit Xcode.

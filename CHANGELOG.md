...
- Adicionada uma opcao Docker para gerar o Android App Bundle (AAB) destinado a publicacao na Google Play Store.
- Atualizada a ferramenta de build Android para Flutter 3.38.10, com Android Gradle Plugin 8.11.1 e Gradle 8.14.
- Atualizados os niveis de API Android para minimo 24 e desejado 36, conforme exigido pela Google Play Store.
